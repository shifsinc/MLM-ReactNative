...
export default class LoginController extends React.Component {
    constructor(props) {
        ...
        // prop = this.props;
        console.log("propsN", this.props.navigator);
    ...
    componentDidMount() {
        GoogleSignin.configure({
            ...
            webClientId: '590542934883-2365uqcr7ho6ibg5q1pj1fg6tbc959r4.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
